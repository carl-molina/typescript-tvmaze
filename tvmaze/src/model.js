...
function searchShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        var params, res, showsData, filteredShowsData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    params = new URLSearchParams({ q: term });
                    return [4 /*yield*/, fetch("".concat(TVMAZE_API_URL, "/search/shows?").concat(params))];
                case 1:
                    res = _a.sent();
                ...
                case 2:
                    ...
                    filteredShowsData = showsData.map(function (s) { return ({
                        id: s.show.id,
                        name: s.show.name,
                        summary: s.show.summary,
                        image: s.show.image ? s.show.image.medium : MISSING_IMAGE_URL,
                    }); });
                    return [2 /*return*/, filteredShowsData];
            }
        });
    });
}
...
function getEpisodesOfShow(id) {
    return __awaiter(this, void 0, void 0, function () {
        var res, showData, filteredShowData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    filteredShowData = showData.map(function (s) { return ({
                        id: s.id,
                        name: s.name,
                        season: s.season,
                        number: s.number
                    ...
                    return [2 /*return*/, filteredShowData];
            }
        });
    });
}
